...
from models.shypergnn_gated import SHyperGNNGated


class SHyperQCriticGated(nn.Module):
    def __init__(self, hidden_dim=64):
        super().__init__()

        self.encoder = SHyperGNNGated(hidden_dim=hidden_dim)
    ...
    def forward(self, graph_state):
        ...
        q_values = self.q_head(action_input).squeeze(-1)
        return q_values